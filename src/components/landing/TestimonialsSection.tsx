    ...
    testimonials: [
      {
        ...
        text: "Alhamdulillah... Managed to bring a student from a G in math to an A. Amazing 👏👏👏",
        rating: 5,
      },
      {
        id: "t2",
        name: "Form 5 Student",
        role: "Last-Minute Joiner",
        text: "I GOT AN A, UNEXPECTED I SWEAR. From F1 to F4 I always failed... Joining the last-minute class was totally worth it miss! 😭😭",
        rating: 5,
      },
      {
        id: "t3",
        name: "SPM Candidate",
        role: "Intensive Class Student",
        text: "TQ miss, because of you my grade jumped from a G to an A. I didn't even expect to get an A 😭",
        rating: 5,
      },
      {
        id: "t4",
        name: "Ex-Student",
        role: "Exam Workshop Student",
        text: "Just checked my results, masyaAllah I can't believe my math that never passed became an A-",
        rating: 5,
      },
    ]
  },
